...
After the tournament ends, Pak Dengklek counts the efficiency of every team. Turns out that he forgot about the efficiency of one of the teams. Given the efficiency of $$$n-1$$$ teams $$$a\_1,a\_2,a\_3,\\ldots,a\_{n-1}$$$. What is the efficiency of the missing team? It can be shown that the efficiency of the missing team can be uniquely determined.
...
The second line contains $$$n-1$$$ integers $$$a\_1,a\_2,a\_3,\\ldots,a\_{n-1}$$$ ($$$-100\\leq a\_i\\leq100$$$) — the efficiency of $$$n-1$$$ teams.
