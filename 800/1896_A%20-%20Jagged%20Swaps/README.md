...
A. Jagged Swapstime limit per test1 secondmemory limit per test256 megabytesinputstandard inputoutputstandard output

You are given a permutation$$$^\\dagger$$$ $$$a$$$ of size $$$n$$$. You can do the following operation 

-   Select an index $$$i$$$ from $$$2$$$ to $$$n - 1$$$ such that $$$a\_{i - 1}  \\lt  a\_i$$$ and $$$a\_i  \\gt  a\_{i+1}$$$. Swap $$$a\_i$$$ and $$$a\_{i+1}$$$.
...
The second line of each test case contains $$$n$$$ integers $$$a\_1, a\_2, \\ldots, a\_n$$$ ($$$1 \\le a\_i \\le n$$$) — the elements of permutation $$$a$$$.
